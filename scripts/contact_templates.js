 ...
 */
function contactTemplate(contact, i, color, firstLetters, contactId) {
    const loggedInUser = getLoggedInUser().username + " " + getLoggedInUser().last_name;
    
    
    return /*html*/ `
    <div class="contact-wrap" tabindex="${i}" onclick="renderInfo(${i}, ${contactId})">
 ...
 */
function contactInfoTemplate(index, color, firstLetters, contactId) {
    return /*html*/ `
        ...
        <div class="mobile-more-options d-none" id="mobile-more-options">
            <div class="edit-options-mobile">
                <div class="option-icon-wrap">
                    <div class="option-icon" onclick="showEditContact(${index}, ${contactId})">
                        <div class="svg-wrap">
                ...
                <div class="option-icon-wrap">
                    <div class="option-icon" onclick="showDeleteConfirmation(${index}, ${contactId})">
                        <div class="svg-wrap">
 ...
 */
function editFormTemplate(index, bgColor, firstLetters, contactId) {
    return /*html*/ `
    ...
    <div class="edit-contact-form-wrapper" onclick="doNotClose(event)">
        ...
        <div class="edit-contact-form">
            ...
            <div class="form-wrapper">
                <form onsubmit="updateContact(event, ${index}, ${contactId}); return false">
                    ...
                    <div class="edit-contact-buttons-wrap">
                        <button class="button cancel outline" onclick="showDeleteConfirmation(${index}, ${contactId}); return false">
                            Delete
                        </button>
...
function deleteConfirmationTemplate(index, contactId) {
    return /*html*/ `
        <h3 class="delete-confirmation-header">Delete contact?</h3>
		<div class="buttons-wrapper">
			<button class="button delete-button" onclick="deleteSingleContact(${index}, ${contactId})">Delete</button>
