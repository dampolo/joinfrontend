  ...
  for (let i = 0; i < subtasksList.length; i++) {
    ...
    lists.innerHTML += /*html*/ `   
                 ...
                 <div class="add-task-subtasks-icons">
                    <img class="add-task-edit" src="./assets/icons/edit_dark.svg"  onclick="editTaskSubtasksList(${i}, event)" >
                     <div class="add-tasks-border"></div>
                    <img  class="add-task-trash" src="./assets/icons/basket.svg" onclick="removeFromAddTaskSubtasksList(${i}, event)">
                 </div>
               </li>
                 `;
  }
